 ...
 */
abstract contract UserBalance is
    ReentrancyGuard,
    ...
    VaultAuthorization
{
        ...
        nonReentrant
    {
        ...
        for (uint256 i = 0; i < ops.length; i++) {
            ...
            ) = _validateUserBalanceOp(ops[i], checkedCallerIsRelayer);
    ...
    function _withdrawFromInternalBalance(
        ...
        _decreaseInternalBalance(
            sender,
            _translateToIERC20(asset),
            amount,
            false
        );
